...
import cn.z201.spring.initialization.*;
...
public class SpiBeanInitializationTest {
    ...
    /**
     * 基于 ServiceLoader spi机制
     *  ServiceLoader<InitFactory> serviceLoader = ServiceLoader.load(InitFactory.class, Thread.currentThread().getContextClassLoader());
     */
    @Test
    ...
    /**
     * 基于 ServiceLoaderFactoryBean spring 对 jdk spi机制封装
     *  ServiceLoader<InitFactory> serviceLoader = config.getBean("initBeanFactoryServiceLoaderFactoryBean", ServiceLoader.class);
     */
    @Test
