...
import cn.z201.example.spring.programming.model.container.IocContainer;
import cn.z201.example.spring.programming.model.container.IocImportContainer;
...
/**
 * @author z201.coding@gmail.com 演示 DefaultListableBeanFactory 基于xml配置信息创建bean
 * AnnotationConfigApplicationContext 基于注解类创建bean 1.基于@Bean 2.基于@Component 3.基于@Import
 * Spring 会避免重复注册。
 **/
public class IocContainerTest {
    ...
    private void lookupCollectionType(BeanFactory beanFactory) {
        if (beanFactory instanceof ListableBeanFactory) {
            ...
            Map<String, SuperInjectionBean> delayLookupMap = listableBeanFactory
                    .getBeansOfType(SuperInjectionBean.class);
