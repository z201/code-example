...
@MapperScan(basePackages = "cn.z201.example.spring.mybatis.audit.persistence.dao")
...
public class AppApplication {
    ...
    public MdcThreadPoolTaskExecutor taskExecutor() {
        MdcThreadPoolTaskExecutor executor = MdcThreadPoolTaskExecutor.newWithInheritedMdc(1, 5, 2, TimeUnit.MINUTES,
