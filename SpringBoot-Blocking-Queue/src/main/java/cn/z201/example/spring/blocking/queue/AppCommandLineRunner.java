...
public class AppCommandLineRunner implements CommandLineRunner {
    ...
    private final ArrayBlockingQueueManager arrayBlockingQueueManager;

    private final LinkedBlockingQueueManager linkedBlockingDequeManager;

    private final PriorityBlockingQueueManager priorityBlockingQueueManager;
